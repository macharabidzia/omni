...
export QWEN_PREWARM_ON_STARTUP="${QWEN_PREWARM_ON_STARTUP:-true}"
export QWEN_PREWARM_MAX_WAIT_SECONDS="${QWEN_PREWARM_MAX_WAIT_SECONDS:-60}"
export QWEN_PREWARM_RETRY_INTERVAL_SECONDS="${QWEN_PREWARM_RETRY_INTERVAL_SECONDS:-2}"
